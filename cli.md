...
- **Export** a wiki database using the [export](cli/wiki-management.md#canasta-export) command
- **Import** a database into an existing wiki using the [import](cli/wiki-management.md#canasta-import) command
...
| [Wiki management](cli/wiki-management.md) | Creating, managing, importing, and exporting wikis and wiki farms |
